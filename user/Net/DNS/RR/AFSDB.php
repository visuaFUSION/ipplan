 ...
 * 
 * Jp 060711 built as AFSDB.php from a copy of MX.php
 * 
 */

/* Net_DNS_RR_AFSDB definition {{{ */
/**
 * A representation of a resource record of type <b>AFSDB</b>
 *
 * @package Net_DNS
 */
class Net_DNS_RR_AFSDB extends Net_DNS_RR
{
    ...
    /* }}} */
    /* Net_DNS_RR_AFSDB::rr_rdata($packet, $offset) {{{ */
